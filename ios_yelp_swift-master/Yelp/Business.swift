...
class Business: NSObject {
    ...
    init(dictionary: NSDictionary) {
        ...
        if location != nil {
            ...
            self.lat = coor!["latitude"] as! Double
            self.lon = coor!["longitude"] as!  Double
    ...
    class func searchWithTermMore(number: Int, term: String, completion: ([Business]!, NSError!) -> Void) {
        YelpClient.sharedInstance.searchWithTermMore(number,term:term, completion: completion)
    }
}
